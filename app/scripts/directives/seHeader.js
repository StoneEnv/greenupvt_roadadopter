/* =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= 
 ...
 | File: seHeader.js
 | Description: A page header directive.
 \ =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= */
'use strict';
define([
    ], function () {

    var module = angular.module('seHeader', ["ui.router"]);
    module.directive('seHeader', ['$rootScope',
        function($rootScope) {
            return {
                restrict: 'E',
                replace: false,
                transclude: false,
                scope: {},
                templateUrl: './views/directives/seHeader.html',
                link: function($scope,elem,attributes) {
                    console.log('Starting Directive [Header]');
                    //========== INIT =====================================================
